package ru.mirea.asalinao.osmmaps;
...
import ru.mirea.asalinao.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker2.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Mirea vernadka", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        marker3.setOnMarkerClickListener(new Marker.OnMarkerClickListener() {
            public boolean onMarkerClick(Marker marker, MapView mapView) {
                Toast.makeText(getApplicationContext(),"Mirea vernadka2", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
